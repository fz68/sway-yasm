...
`
	shellSwitcher = `
    alacritty -o font.size=16.0 --class 'sway-yasm' --command sway-yasm fzf switcher 
`
	shellPickWin = `
    alacritty -o font.size=16.0 --class 'sway-yasm' --command sway-yasm fzf pick-win
`
	shellPickSpace = `
    alacritty -o font.size=16.0 --class 'sway-yasm' --command sway-yasm fzf pick-space
`
	shellPath = `
    alacritty -o font.size=16.0 --class 'sway-yasm' --command sway-yasm fzf path
`
	shellClipboard = `
    alacritty -o font.size=16.0 --class 'sway-yasm' --command sway-yasm fzf clipboard
`
)
